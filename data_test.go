...
func TestData(t *testing.T) {
	tests := map[string]struct {
		...
		"AD": {iso3166.AD, "AD", "AND", 20},
		"AE": {iso3166.AE, "AE", "ARE", 784},
		"AF": {iso3166.AF, "AF", "AFG", 4},
		"AG": {iso3166.AG, "AG", "ATG", 28},
		"AI": {iso3166.AI, "AI", "AIA", 660},
		"AL": {iso3166.AL, "AL", "ALB", 8},
		"AM": {iso3166.AM, "AM", "ARM", 51},
		"AO": {iso3166.AO, "AO", "AGO", 24},
		"AQ": {iso3166.AQ, "AQ", "ATA", 10},
		"AR": {iso3166.AR, "AR", "ARG", 32},
		"AS": {iso3166.AS, "AS", "ASM", 16},
		"AT": {iso3166.AT, "AT", "AUT", 40},
		"AU": {iso3166.AU, "AU", "AUS", 36},
		"AW": {iso3166.AW, "AW", "ABW", 533},
		"AX": {iso3166.AX, "AX", "ALA", 248},
		"AZ": {iso3166.AZ, "AZ", "AZE", 31},
		"BA": {iso3166.BA, "BA", "BIH", 70},
		"BB": {iso3166.BB, "BB", "BRB", 52},
		"BD": {iso3166.BD, "BD", "BGD", 50},
		"BE": {iso3166.BE, "BE", "BEL", 56},
		"BF": {iso3166.BF, "BF", "BFA", 854},
		"BG": {iso3166.BG, "BG", "BGR", 100},
		"BH": {iso3166.BH, "BH", "BHR", 48},
		"BI": {iso3166.BI, "BI", "BDI", 108},
		"BJ": {iso3166.BJ, "BJ", "BEN", 204},
		"BL": {iso3166.BL, "BL", "BLM", 652},
		"BM": {iso3166.BM, "BM", "BMU", 60},
		"BN": {iso3166.BN, "BN", "BRN", 96},
		"BO": {iso3166.BO, "BO", "BOL", 68},
		"BQ": {iso3166.BQ, "BQ", "BES", 535},
		"BR": {iso3166.BR, "BR", "BRA", 76},
		"BS": {iso3166.BS, "BS", "BHS", 44},
		"BT": {iso3166.BT, "BT", "BTN", 64},
		"BV": {iso3166.BV, "BV", "BVT", 74},
		"BW": {iso3166.BW, "BW", "BWA", 72},
		"BY": {iso3166.BY, "BY", "BLR", 112},
		"BZ": {iso3166.BZ, "BZ", "BLZ", 84},
